				...
				<div class="row">
					<div class="col-5">
						...
						<label class="custom-file w-100">
							<input type="file" name="foto" class="custom-file-input" id="foto" ref="file" @change="fieldChange()" accept="image/*" multiple>
						...
						<button type="button" class="btn btn-outline-secondary mt-4 px-5" :disabled="uploadPhotos.length == 0" @click="uploadFile">Додати</button>
					</div>
				</div>
			</form>
